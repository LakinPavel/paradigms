...
public class binAnd extends binOperation {
    private myExpression x;
    private myExpression y;
    private int priority = -2;

    public binAnd(myExpression x, myExpression y) {
        super(x, y, " & ");
        this.x = x;
        this.y = y;
    }
    ...
    public BigInteger evaluate(BigInteger a) {
        return this.x.evaluate(a).and(this.y.evaluate(a));
    }

    @Override
    public BigInteger BigEvaluate() {
        return this.x.BigEvaluate().and(this.y.BigEvaluate());
    }
}
