...
public class binOr extends binOperation {
    private myExpression x;
    private myExpression y;
    private int priority = -6;

    public binOr(myExpression x, myExpression y) {
        super(x, y, " | ");
        this.x = x;
        this.y = y;
    }
    ...
    public BigInteger evaluate(BigInteger a) {
        return this.x.evaluate(a).or(this.y.evaluate(a));
    }

    @Override
    public BigInteger BigEvaluate() {
        return this.x.BigEvaluate().or(this.y.BigEvaluate());
    }
}
