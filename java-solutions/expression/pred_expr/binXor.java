...
public class binXor extends binOperation {
    private myExpression x;
    private myExpression y;
    private int priority = -4;

    public binXor(myExpression x, myExpression y) {
        super(x, y, " ^ ");
        this.x = x;
        this.y = y;
    }
    ...
    public BigInteger evaluate(BigInteger a) {
        return this.x.evaluate(a).xor(this.y.evaluate(a));
    }

    @Override
    public BigInteger BigEvaluate() {
        return this.x.BigEvaluate().xor(this.y.BigEvaluate());
    }
}
